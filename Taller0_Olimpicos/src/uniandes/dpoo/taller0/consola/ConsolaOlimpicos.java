...
{
	/**
	 * Esta es la calculadora de estad√≠sticas que se usar√° para hacer todas las
	 * operaciones de la aplicaci√≥n. Esta calculadora tambi√©n contiene toda la
	 * informaci√≥n sobre los atletas despu√©s de que se cargue desde un archivo.
	 */
	...
	{
		System.out.println("EstadÌsticas sobre los Juegos OlÌmpicos\n");
		...
		while (continuar)
		{
			try
			{
				...
				{
					System.out.println("Saliendo de la aplicaciÛn ...");
					continuar = false;
				}
				else if (calculadora == null)
				{
					System.out.println("Para poder ejecutar esta opciÛn primero debe cargar un archivo de atletas.");
				}
				else
				{
					System.out.println("Por favor seleccione una opciÛn v·lida.");
				}
			}
	...
	public void mostrarMenu()
	{
		...
		System.out.println("2. Consultar los atletas de un aÒo dado");
		System.out.println("3. Consultar las medallas de un atleta en un periodo");
		System.out.println("4. Consultar los atletas de un paÌs dado");
		System.out.println("5. Consultar el paÌs con m·s medallistas");
		System.out.println("6. Consultar todos los medallistas de un evento dado");
		System.out.println("7. Consultar los atletas con un mÌnimo de medallas");
		System.out.println("8. Consultar el atleta estrella de todos los tiempos");
		System.out.println("9. Consultar mejor paÌs en un evento");
		System.out.println("10. Consultar el atleta todoterreno");
		System.out.println("11. Consultar los medallistas por paÌs y gÈnero");
		System.out.println("12. Consultar el porcentaje de atletas que son medallistas");
		System.out.println("13. Consultar el paÌs al que representa un atleta a partir de su nombre");
		System.out.println("14. Salir de la aplicaciÛn\n");
	}
	
	private void ejecutarAtletaPais()
	{
		System.out.println("\n" + "PaÌs al que representa el atleta" + "\n");
		
		String nombre = input("Por favor ingrese el nombre de un atleta");
		String nombre_pais = calculadora.atletaPais(nombre);
		System.out.println("El paÌs al que pertenece el atleta " + nombre + " es " + nombre_pais);
	}
	...
	/**
	 * Le pide el usuario el nombre de un pa√≠s y un g√©nero, y luego le muestra la
	 * informaci√≥n de los medallistas de ese g√©nero que han representado a ese pa√≠s.
	 */
	private void ejecutarMedallistasPorNacionYGenero()
	{
		System.out.println("\n" + "Medallistas por paÌs y gÈnero" + "\n");
		...
		{
			System.out.println("SÛlo puede seleccionar M o F");
		}
		else
		{
			...
			{
				System.out.println("No se encontraron medallistas del paÌs ingresado.");
			}
		}
	}
	...
	private void ejecutarMejorPaisEnUnEvento()
	{
		...
		else
		{
			...
			for (Map.Entry<String, int[]> entry : mejores.entrySet())
			{
				...
				System.out.println(entry.getKey() + "ha ganado: " + medallas[0] + " oros, " + medallas[1] + " platas, "
						+ medallas[2] + " bronces.");
			}
		}
	}
	...
	/**
	 * Muestra cu√°les han sido los atletas (o el atleta) que m√°s medallas ha ganado.
	 */
	private void ejecutarAtletaEstrella()
	{
		...
		for (Map.Entry<String, Integer> entry : estrellas.entrySet())
		{
			...
			int medallas = entry.getValue();
			System.out.println(nombre + " ganÛ " + medallas + " medallas");
		}

	}

	/**
	 * Le pide al usuario una cantidad m√≠nima de medallas y luego le muestra la
	 * informaci√≥n de los atletas que han ganado m√°s de esa cantidad de medallas.
	 */
	private void ejecutarAtletasConMasMedallasQue()
	{
		System.out.println("\n" + "Atletas con mÌnimo de medallas" + "\n");

		try
		{
			int cantidadMinima = Integer.parseInt(input("Ingrese la cantidad mÌnima de medallas"));
			Map<String, Integer> atletas = calculadora.atletasConMasMedallas(cantidadMinima);
			System.out.println(
					"Hay " + atletas.size() + " atletas que han ganado m·s de " + cantidadMinima + " medallas.");
		...
		{
			System.out.println("El n√∫mero ingresado no es v√°lido. Por favor escriba un n√∫mero entero.");
		}
	}
	...
	/**
	 * Consulta el pa√≠s (o los pa√≠ses) con m√°s medallistas
	 */
	private void ejecutarPaisConMasMedallistas()
	{
		System.out.println("\n" + "PaÌs con m·s medallistas" + "\n");

		Map<String, Integer> paises = calculadora.paisConMasMedallistas();
		if (paises.size() > 1)
		{
			System.out.println("Hay " + paises.size() + " paÌses empatados en el primer lugar.");
		}
	...
	/**
	 * Le pide al usuario el nombre de un pa√≠s y luego le muestra la informaci√≥n de
	 * todos los atletas de ese pa√≠s.
	 */
	private void ejecutarAtletasPorPais()
	{
		...
		if (atletas == null)
		{
			System.out.println("No existe un paÌs con ese nombre");
		}
		else
		{
	...
	/**
	 * Le pide al usuario un rango de a√±os y el nombre de un atleta. A continuaci√≥n
	...
	private void ejecutarMedallasEnRango()
	{
		...
		try
		{
			int anio_inicial = Integer.parseInt(input("Ingrese el aÒo inicial para el rango"));
			int anio_final = Integer.parseInt(input("Ingrese el aÒo final para el rango"));
			...
			if (medallas == null)
			{
				System.out.println("No se encontrÛ un atleta llamado " + nombre_atleta);
			}
			else
			{
				System.out.println("El atleta " + nombre_atleta + " ha ganado " + medallas.size() + " medallas.");
	...
	/**
	 * Ejecuta la opci√≥n para consultar los atletas de un a√±o.
	 */
	private void ejecutarAtletasPorAnio()
	{
		System.out.println("\n" + "Medallas de un atleta en un periodo" + "\n");

		int anio = Integer.parseInt(input("Ingrese el aÒo de su interÈs"));
	...
	/**
	 * Este m√©todo le pide al usuario el nombre de un archivo con informaci√≥n de los
	...
	private void ejecutarCargarAtletas()
	{
		...
		try
		{
			...
			System.out.println("Se cargÛ el archivo " + archivo + " con informaciÛn de los Juegos OlÌmpicos.");
			Collection<String> eventos = calculadora.darNombresDeportes();
			System.out.println("Los deportes para los que se tiene informaciÛn son:");
		...
		{
			System.out.println("ERROR: el archivo indicado no se encontrÛ.");
		}
		catch (IOException e)
		{
